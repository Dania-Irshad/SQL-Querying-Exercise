...
-- Hint: You don’t need to do it this way, but it’s possible to do with a subquery: http://www.postgresqltutorial.com/postgresql-max-function/ --
SELECT * FROM analytics
    WHERE last_updated = (
...
SELECT SUM(reviews) AS review_count FROM analytics;
